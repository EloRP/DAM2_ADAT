...
public class Libro {
    ...
    public Libro(String ID, String isbn, String titulo, int numero_de_paginas, List<String> autores,
            LocalDate fechaEdicion, String editorial, double precio, List<Copia> copias) {
        this.ID = ID;
        this.isbn = isbn;
        this.titulo = titulo;
    ...
    public String toString() {
        ...
        sb.append("Fecha de Edición: ").append(fechaEdicion.format(DateTimeFormatter.ofPattern("dd/MM/yyyy")))
                .append("\n");
